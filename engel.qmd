...
Las medidas de bondad del ajuste pueden usarse para comparar modelos cuando la variable dependiente es la misma. El $R^2$ ajustado para el modelo A es `r round(Rsq(mod_A, adjusted = TRUE), 2)`, mientras que para el modelo B es `r round(Rsq(mod_B, adjusted = TRUE), 2)`. De acuerdo con este criterio, el modelo B sería preferible.
